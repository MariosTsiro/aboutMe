# Marios Tsirogiannis - Software Developer
...
- **[Gamehearts CMS](https://gamehearts.eu/)** - A CMS service designed for managing content across various platforms. It connects with APIs, supports secure user authentication via Keycloak, and integrates with PostgreSQL for data storage.
- **[REBOOT](https://thereboot-project.eu/)** - A newsletter service setup with EmailJS and Mailjet. This project focuses on sending out personalized, scalable newsletters to large subscriber lists.

Note: My repositories are private, but you can explore my projects online through the links above.

## Let's Connect

- **LinkedIn**: **[Marios Tsirogiannis]([https://gamehearts.eu/](https://www.linkedin.com/in/marios-tsirogiannis-48b8b914b/))**(#)
